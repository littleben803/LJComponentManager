...
@implementation LJNavigator

+ (LJNavigator *)getInstance {
    
    static LJNavigator *sharedConnector = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        
        if (sharedConnector == nil) {
            
            sharedConnector = [[LJNavigator alloc] init];
        }
    });
...
@implementation LJNavigator (HookRouteBlock)
